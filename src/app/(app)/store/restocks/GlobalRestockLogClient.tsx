    ...
    <div className={dark
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 md:px-6">
          ...
          <div className={dark
            ...
            <form className="flex flex-col gap-3 sm:flex-row sm:items-center">
              <input name="q" defaultValue={q}
                placeholder="Search site, item, item code, supplier, receiver..."
                className={dark
              ...
              {q && (
                <Link href="/store/restocks" className={dark
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          ...
          <SummaryCard dark={dark} label="Visible Quantity Added"  value={String(totalQuantityAdded)}
        ...
        <section className={dark
          ...
          <div className="flex items-center justify-between px-5 py-4">
            <div className={dark ? "text-sm font-semibold text-slate-100" : "text-sm font-semibold text-[#1a1814]"}>Restock Records</div>
            <div className={dark ? "text-xs text-slate-500" : "text-xs text-[#8b857c]"}>{restocks.length} shown</div>
          </div>
                ...
                {restocks.length === 0 ? (
                  ...
                  <tr key={row.id} className={dark ? "hover:bg-white/5" : "hover:bg-[#fcfaf7]"}>
                    ...
                    <td className="px-5 py-3">
                      <Link href={`/store/sites/${row.inventorySite.id}`}
                    ...
                    <td className={dark ? "px-5 py-3 text-slate-100" : "px-5 py-3 text-[#1a1814]"}>
                      ...
                      <div className="mt-0.5 flex flex-col gap-0.5">
                        ...
                        {row.inventoryItem.entityDisplay !== "-" && (
